...
alter TABLE CAMPO_AFECTADO_APROVISIONAM MODIFY COLUMN ID_CAMPO_AFECTADO INT(3) AUTO_INCREMENT;
...
ALTER TABLE CAMPO_AFECTADO_DISTRIBUCION MODIFY COLUMN ID_CAMPO_AFECTADO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_MOVIMIENTO_DISTRIBUCION MODIFY COLUMN ID_TIPO_MOVIMIENTO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_ENVIO_SALIDA MODIFY COLUMN ID_TIPO_ENVIO_SALIDA INT(3) AUTO_INCREMENT;
...
ALTER TABLE ESTADO_ENVIO_SALIDA MODIFY COLUMN ID_ESTADO_ENVIOSAL INT(3) AUTO_INCREMENT;
...
ALTER TABLE ESTADO_PRODUCTO MODIFY COLUMN ID_ESTADO_PRODUCTO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_PRODUCTO MODIFY COLUMN ID_TIPO_PRODUCTO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_PRIORIDAD MODIFY COLUMN ID_PRIORIDAD INT(3) AUTO_INCREMENT;
...
ALTER TABLE ESTADO_PROVEEDOR MODIFY COLUMN ID_ESTADO_PROVEEDOR INT(3) AUTO_INCREMENT;
...
ALTER TABLE ESTADO_ENVIO_ENTRADA MODIFY COLUMN ID_ESTADO_PEDIDO INT(3) AUTO_INCREMENT;
...
ALTER TABLE ESTADO_USUARIO MODIFY COLUMN ID_ESTADO_USUARIO INT(3) AUTO_INCREMENT;
...
ALTER TABLE CAMPO_AFECTADO_PRODUCTO MODIFY COLUMN ID_CAMPO_AFECTADO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_MOVIMIENTO_PRODUCTO MODIFY COLUMN ID_TIPO_MOVIMIENTO INT(3) AUTO_INCREMENT;
...
ALTER TABLE TIPO_MOVIMIENTO_USR_SISTEMA MODIFY COLUMN ID_TIPO_MOVIMIENTO INT(3) AUTO_INCREMENT;
...
ALTER TABLE CAMPO_AFECTADO_USR_SISTEMA MODIFY COLUMN ID_CAMPO_AFECTADO INT(3) AUTO_INCREMENT;
/********************************************************************************************************/
...
ALTER TABLE CONSUMIDOR_FINAL ADD CONSTRAINT PK_CFNIP PRIMARY KEY(NIP);
...
ALTER TABLE PROVEEDOR MODIFY COLUMN ID_PROVEEDOR INT(10) AUTO_INCREMENT;
